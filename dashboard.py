...
def generate_dashboard(template_path, csv_file, output_folder, start_date, end_date):
    ...
    try:
        ...
        try:
            ...
            data_sheet.clear() 
            # Write the new filtered data starting at cell A1
            # index=False avoids writing the pandas row numbers
...
st.title("Machine Efficiency Dashboard Generatorthis one")
